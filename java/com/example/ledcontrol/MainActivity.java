...
public class MainActivity extends AppCompatActivity {
    ...
    void toggle(){
        ...
        //String request = "getIngred/more" + ingredient;
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            /*for(int i = 0; i<obj.length();i++) {
                                results.add(obj.getString(String.valueOf(i)));
                                //}

                                String[] broken = results.get(i).split(",");
                                for (int j = 0; j < broken.length; j++) {
                                    broken[j] = broken[j].replace("\"", "").replace("[", "").replace("]", "");
                                    Log.d("item", broken[j]);
                                }
                                Log.d("BREAK", "next\n");
                            }*/
                            //box.setText(results.get(0));
